function [dimp_h_red, dimp_h_blue] = intensity_abs_h_ID(pixels, norm_int, ind_int)
...
red_at_blue_exp = flip(norm_red(ind_blue(1:p4))); % Flip so that height is increasing
blue_at_red_exp = flip(norm_blue(ind_red(1:p3))); % Flip so that height is increasing
